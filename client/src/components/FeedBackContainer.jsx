...
export const HowToComponent = (props) => {
  ...
  const newCard = (
    <div className="">
      <div className="flex justify-center rounded-lg shadow-[0px_2px_4px_rgba(26,_47,_79,_0.2)] w-[280px] sm:w-[375px] xl:w-[320px] h-[100px] p-4 bg-white dark:bg-app-container-dark text-gray-900 dark:text-gray-100 border-lightslategray-300 border border-solid dark:border-lightslategray-200 dark:border dark:border-solid">
