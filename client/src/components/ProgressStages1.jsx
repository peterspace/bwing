...
export const ProgressStages1 = () => {
  const progressStage1 = (
    <div className="flex justify-center rounded-lg p-4 bg-chizzySnow dark:bg-background-dark">
      ...
      <div className="flex flex-col gap-[24px]">
        <div className="flex flex-col gap-[10px]">
          ...
          <div className="flex flex-row items-center justify-between">
            <div className="flex flex-row w-full h-[12px] bg-chizzySnow rounded-lg"></div>
