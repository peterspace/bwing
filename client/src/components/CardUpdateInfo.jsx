        ...
        <div className="flex flex-col gap-[12px] p-4">
          <div className="flex flex-col justify-center items-center gap-[24px]">
            <div className="flex flex-col gap-[10px]">
              ...
              <div className="flex bg-lightslategray-300 dark:bg-lightslategray-200 md:w-[452px] w-[320px] xs:w-[340px] h-[1px] dark:h-[1.5px]" />
            </div>

            <div className="flex flex-col w-[320px] xs:w-[340px] md:w-[452px] rounded border-[1px] border-solid border-lightslategray-300 dark:border-lightslategray-200 p-2 overflow-scroll h-[300px] bg-white dark:bg-bgDarkMode">
              <>
                <div
                ...
                >
                  ...
                  <div className="flex flex-row justify-between h-[24px] mt-[8px]">
                    ...
                    <div className="flex flex-row justify-center items-center gap-1">
                      ...
                      >
                        {item?.userAddress &&
                          item?.userAddress?.substring(0, 22)}
                        ...
                      </span>
                      <span
                        className="transition-transform duration-300 hover:scale-125 cursor-pointer text-chizzyIcon dark:text-chizzyIcon"
          ...
          <div className="flex flex-col justify-center items-center gap-[8px] bg-white dark:bg-app-container-dark rounded border-[1px] border-solid border-lightslategray-300 dark:border-lightslategray-200 p-2">
                  ...
                  >
                    <div className="w-full">
                      ...
                      <input
                        ...
                        onChange={(ev) =>
                          setDispatcherTelegram(ev.target.value)
                        }
                      />
                    </div>
                    <div className="cursor-pointer mr-2 flex justify-center items-center w-[18px] h-[64px] overflow-hidden text-darkslategray-200 dark:text-gray-100">
            ...
            {isLoading ? (
              <div className="button-gradient">{message}</div>
            ) : (
              <div className="button-gradient" onClick={updateTransaction}>
                {message}
              </div>
            )}
            {/* <button className="bg-gradient-to-r from-blue-500 to-purple-500 text-white font-semibold py-2 px-4 rounded">
              Gradient Button
            </button>
