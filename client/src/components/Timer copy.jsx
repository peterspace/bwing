      ...
      <div className="flex flex-col justify-center items-center gap-[24px] w-full py-2 mt-4">
        <div className="flex flex-col gap-[10px]">
          <div className="flex flex-row gap-2 mt-2">
            ...
            {/* <div className="text-base leading-[24px] text-gray-300 dark:text-white inline-block w-[69px]">
          ...
          <div className="text-xs leading-[18px] text-darkslategray-100 dark:text-gray-100 inline-block">
          ...
          <div className="">
            <div className="flex flex-row gap-2 mt-2">
              <div className="leading-[20px] text-gray-300 dark:text-white inline-block">
                {txData?.orderNo}
              </div>
              <div
            ...
            <div className="text-xs leading-[18px] text-darkslategray-100 dark:text-gray-100 inline-block w-[87px]">
              Transaction ID
            </div>
          </div>
        </div>
