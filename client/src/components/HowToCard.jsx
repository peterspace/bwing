...
export const HowToComponent = (props) => {
  ...
  const newCard = (
    <div className="card-gradient">
      <div className="flex justify-center rounded-lg shadow-[0px_2px_4px_rgba(26,_47,_79,_0.2)] w-[280px] sm:w-[375px] xl:w-[500px] h-fit xl:h-[125px] p-4 bg-white dark:bg-app-container-dark text-gray-900 dark:text-gray-100 dark:border-lightslategray-300 dark:box-border dark:border dark:border-solid">
        <div className="flex flex-row gap-2 w-full">
          ...
          <div className="flex flex-col">
            ...
            <div className="leading-[20px] inline-block text-gray-900 dark:text-gray-200 overflow-y-scroll overflow-x-hidden h-fit xl:h-[80px]">
              {l?.description}
            </div>
          </div>
        </div>
