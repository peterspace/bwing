const SupportLight = () => {
  return (
    <div className="relative bg-white dark:bg-gray-400 w-full h-[960px] overflow-hidden text-left text-xs text-gray-500 font-roboto">
      <div className="absolute top-[calc(50%_-_400px)] left-[calc(50%_-_193px)] rounded-lg bg-white dark:bg-background-dark overflow-hidden flex flex-col items-start justify-start p-[5px] border-[1px] border-solid border-lightslategray-300">
        <div className="rounded-lg bg-white dark:bg-background-dark w-[375px] overflow-hidden flex flex-col items-center justify-start p-2.5 box-border gap-[20px]">
          ...
          <div className="w-[375px] flex flex-col items-start justify-start py-0 px-2.5 box-border gap-[10px]">
            ...
            <div className="rounded-xl bg-chizzySnow dark:bg-exchange-rate-dark overflow-hidden flex flex-row items-center justify-start h-[30px] px-3 gap-[8px] text-gray-200 dark:text-silver">
          ...
          <div className="rounded-lg bg-chizzySnow dark:bg-gray-1000 box-border w-[363px] flex flex-col items-start justify-start py-0 px-2.5 gap-[10px] border-[1px] border-solid border-lightslategray-300">
            ...
            <div className="self-stretch flex flex-row items-start justify-start py-[5px] px-0 gap-[10px] text-sm text-gray-500">
          ...
          <div className="rounded-lg bg-chizzySnow dark:bg-gray-1000 box-border w-[363px] h-[120px] flex flex-col items-start justify-start py-0 px-2.5 gap-[10px] border-[1px] border-solid border-lightslategray-300">
            <b className="relative leading-[28px] inline-block w-[167px]">
              Comment
            </b>
            <div className="self-stretch flex flex-row items-start justify-start gap-[10px] text-sm text-gray-500">
