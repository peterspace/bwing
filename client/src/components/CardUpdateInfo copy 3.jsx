    ...
    >
      <div className="flex flex-col gap-[24px]">
        <div className="flex flex-col gap-[24px]">
          ...
          <div className="flex flex-col w-[320px] xs:w-[340px] md:w-[452px] mb-8 rounded border-[1px] border-solid border-lightslategray-300 p-2 overflow-scroll h-[300px] bg-white dark:bg-bgDarkMode">
            <>
              <div
