  ...
  return (
    <>
      ...
      <div className="mt-2 grid gap-2 grid-cols-3 md:grid-cols-4 lg:grid-cols-6">
        ...
        <label className="cursor-pointer flex items-center gap-1 justify-center border bg-chizzySnow dark:bg-gray-1000 rounded-2xl p-2 text-2xl text-gray-600">
          <input
            type="file"
            multiple
            className="hidden"
