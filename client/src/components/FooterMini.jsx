...
const FooterMini = () => {
  ...
  const footer = (
    <div className="self-stretch lg:h-[70px] mb-4 px-6 lg:py-5 flex-col justify-start items-end gap-2.5 flex text-gray-900 dark:text-gray-200">
      {/* <div className="relative bg-lightslategray-300 w-full h-px overflow-hidden shrink-0 mb-2" /> */}
      <div className="self-stretch flex flex-col lg:flex-row gap-2 lg:justify-between items-end lg:inline-flex w-full">
