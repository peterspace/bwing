    ...
    <>
      {isTokenModalOpen && (
        <div
          ...
          // className="self-stretch flex flex-row items-start justify-start py-0 px-1 box-border max-w-full mt-[-446px] xl:mt-[-536px] w-[375px] xl:w-[470px] 2xl:w-[600]"
          // className="self-stretch flex flex-row items-start justify-start py-0 px-1 box-border max-w-full mt-[-576px] xl:mt-[-536px] w-[375px] xl:w-[470px] 2xl:w-[600]"
          className={`self-stretch flex flex-row items-start justify-start py-0 px-1 box-border max-w-full w-[375px] xl:w-[470px] 2xl:w-[600] ${
            service === 'exchange'
              ? 'mt-[-446px] xl:mt-[-536px]'
              : 'mt-[-576px] xl:mt-[-536px]'
          }`}
        >
