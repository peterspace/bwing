...
export const DashboardMenuAdminMobile = (props) => {
  ...
  return (
    <Card
      ...
      className="h-[calc(100vh-2rem)] w-[200px] p-10 pr-6 shadow-xl shadow-blue-gray-900/5 box-border rounded-none bg-white dark:bg-app-container-dark text-gray-900 dark:text-gray-100"
    >
      ...
      <List className="flex flex-col text-gray-900 dark:text-gray-100 w-full p-1 font-normal gap-2 overflow-y-scroll overflow-x-hidden">
        ...
        <Accordion open={true}>
          <ListItem
            ripple={false}
            className={`p-0 w-fit ${isSubMenuOpen === 2 ? 'bg-[#ECEAFF]' : ''}`}
            selected={isSubMenuOpen === 2}
          >
            <AccordionHeader
              onClick={() => {
