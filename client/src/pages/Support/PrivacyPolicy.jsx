      ...
      <div className="flex flex-col items-center h-[500px] w-[512px] overflow-y-auto m-4 gap-4">
        <div className="flex flex-col gap-2">
          ...
          <div className="flex flex-col justify-start gap-2 text-slate-400">
            <div className="flex">
              {`This Privacy and Data Retention Policy (the Policy) explains the way in which Blendery (hereinafter referred to “Sum & Substance”) collect, use, share, and protect Personal Information of Users ("you") obtained through blendery.io, any related applications (including but not limited to the mobile one) and exchange tools integrated into third party services (“Services”). The terms “we,” “us,” and “our” refer to the entities indicated below.`}
            </div>
            <div className="flex">
