...
const AdminTransactionsTableMobile = ({ data, tableData, setPage }) => {
  ...
  return (
    <div>
      ...
      <div className="flex flex-col gap-2 overflow-y-scroll overflow-x-hidden h-full">
      <div className="rounded-lg bg-white dark:bg-app-container-dark text-gray-900 dark:text-gray-100 w-fit">
