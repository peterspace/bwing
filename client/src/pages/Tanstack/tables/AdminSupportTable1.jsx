...
const services1 = {
  ...
  serviceList: ['exchange', 'buy', 'sell', 'defi'],
};

const services2 = ['exchange', 'buy', 'sell', 'defi'];
const services = [
  { id: 'exchange', name: 'Exchange', color: 'bg-[#089708]' },
  { id: 'buy', name: 'Buy', color: 'bg-[#FFA500]' },
  { id: 'sell', name: 'Sell', color: 'bg-[#800080]' },
...
const AdminSupportTable = ({ data, tableData }) => {
  ...
  const handleServiceToggleDropdown = () => {
    setSearchTerm('');
    setIsServiceDropdownOpen(!isStatusDropdownOpen);
  };
