...
import MemoizedAdminMessagessTable from './tables/AdminMessagesTable';
import NoTransactionFound from '../../components/NoTransactionFound';

const AdminMessagesRecord = (props) => {
  ...
  return (
    <div className="container mx-auto bg-[#F3F3F3] dark:bg-bgDarkMode text-gray-900 dark:text-gray-100">
      {tableData.length ? (
        <MemoizedAdminMessagessTable data={data} tableData={tableData} setActiveMessage={setActiveMessage} setIsSelectMessage={setIsSelectMessage} />
      ) : (
        <NoTransactionFound />
      )}
    </div>
...
export default AdminMessagesRecord;
