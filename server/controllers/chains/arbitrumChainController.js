 const ChainsArbitrum = require('../../models/Chains/Arbitrum.js');

//Require tokenId
//==========================================={chain}======================================
//======================================={Create Token}=============================================================================================
const addNewChainsArbitrum = async (req, res) => {
  const {
    chainId,
    name,
    address,
  ...
  const duplicate = await ChainsArbitrum.findOne({ address })
...
// To get all networks
const getChainsArbitrum = async (req, res) => {
  const chain = await ChainsArbitrum.find();
  if (!chain?.length) {
...
//   const token = await ChainsArbitrum.findById(id).exec()
...
const updateChainsArbitrum = async (req, res) => {
  const {
    id,
    chainId,
    name,
...
const deleteChainsArbitrum = async (req, res) => {
  const { id } = req.body;
