...
async function verifyEthereumGas() {
  const response = await getGasEstimatesEthereum();
  console.log({ firstResponse: response });
  if (response) {
    console.log({ receivedResponse: response });
    return response;
...
async function verifyEthereumGasPrice() {
  const response = await getGasPriceEthereum();
  console.log({ firstResponse: response });
  if (response) {
    console.log({ receivedResponse: response });
    return response;
