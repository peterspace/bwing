...
const userTokensAuroraSchema = new mongoose.Schema(
  {
    walletId: {
...
const  UserTokensAurora = mongoose.model("UserTokensAurora", userTokensAuroraSchema);
module.exports = UserTokensAurora;