...
const userTokensBinanceSchema = new mongoose.Schema(
  {
    walletId: {
...
const  UserTokensBinance = mongoose.model("UserTokensBinance", userTokensBinanceSchema);
module.exports = UserTokensBinance;