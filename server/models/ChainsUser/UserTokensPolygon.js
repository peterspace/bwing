...
const userTokensPolygonSchema = new mongoose.Schema(
  {
    walletId: {
...
const  UserTokensPolygon = mongoose.model("UserTokensPolygon", userTokensPolygonSchema);
module.exports = UserTokensPolygon;